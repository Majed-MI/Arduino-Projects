...
{
  { Servo(), 27 , "Base",150},
  { Servo(), 26 , "Shoulder",20},
  { Servo(), 25 , "Elbow", 160},
  { Servo(), 33 , "Gripper",120},
};
...
<html>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    ...
    input[type=button]
    {
      background-color:blue;color:white;border-radius:30px;width:80%;height:40px;font-size:20px;text-align:center;
    }
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">Project For 3-2</h1>
    ...
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <tr>
        ...
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="0" max="180" value="120" class="slider" id="Gripper" oninput='sendButtonInput("Gripper",value)'>
          </div>
        </td>
      </tr> 
      <tr/><tr/>
      <tr>
        ...
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="0" max="180" value="160" class="slider" id="Elbow" oninput='sendButtonInput("Elbow",value)'>
          </div>
        </td>
      </tr> 
      <tr/><tr/>      
      ...
      <tr>
        ...
        <td colspan=2>
         <div class="slidecontainer">
            <input type="range" min="0" max="180" value="150" class="slider" id="Base" oninput='sendButtonInput("Base",value)'>
          </div>
        </td>
      </tr> 
      <tr/><tr/> 
    ...
    <script>
      ...
      function initRobotArmInputWebSocket() 
      {
        ...
        websocketRobotArmInput.onmessage    = function(event)
        {
          ...
          {
            button.style.backgroundColor = (button.value == "ON" ? "black" : "blue");  
